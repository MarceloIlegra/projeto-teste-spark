...
public class ActivityServiceTest {
    ...
    @Test
    public void validaDiasEntreDatas() {
        LocalDateTime today = LocalDateTime.now();
        LocalDateTime startDate = LocalDateTime.of(2014, Month.MARCH, 10, 10, 20);
        assertFalse(ActivityService.validadeBetweenDates(startDate));
        
    }

    @Test
    public void validaSeDataLancadaÉMaiorQueHoje() {
        LocalDateTime today = LocalDateTime.now();
        LocalDateTime startDate = LocalDateTime.of(2014, Month.NOVEMBER, 5, 10, 20);
